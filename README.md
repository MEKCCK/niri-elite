...
Forked from [niri-wm/niri](https://github.com/niri-wm/niri), with merged features from [SHORiN-KiWATA](https://github.com/SHORiN-KiWATA)'s niri-elite work.

- [MEKCCK](https://github.com/MEKCCK) — fork maintainer

### Upstream niri

Special thanks to [Ivan Molodetskikh](https://github.com/YaLTeR) and all niri contributors for creating and maintaining niri:
